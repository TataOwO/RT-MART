...
function ReviewSection({ reviews, statistics }) {
            ...
            <div key={star} className={styles.distributionRow}>
              ...
              <div className={styles.progressBar}>
                <div
                  ...
                  style={{ width: `${getPercentage(statistics.distribution[star])}%` }}
                />
              </div>
              <span className={styles.countLabel}>{statistics.distribution[star]}</span>
            </div>
          ))}
        </div>
      </div>
